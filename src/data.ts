...
export const PALETTES: Palette[] = [
  {
    ...
    shades: [
      { key: "50", label: "Rose 50", hex: "#FFEAE7", depthLabel: "a pale blush tint" },
      { key: "100", label: "Rose 100", hex: "#FFE1DE", depthLabel: "a very light rose tint" },
      { key: "200", label: "Rose 200", hex: "#FFCDCB", depthLabel: "a light soft rose shade" },
      { key: "300", label: "Rose 300", hex: "#FFB5B3", depthLabel: "a soft light-rose shade" },
      { key: "400", label: "Rose 400", hex: "#FF9998", depthLabel: "a medium-light coral-rose" },
      { key: "500", label: "Rose 500", hex: "#FF7A7B", depthLabel: "the base coral-rose tone" },
      { key: "600", label: "Rose 600", hex: "#E0686B", depthLabel: "a deep dusty-rose tint" },
      { key: "700", label: "Rose 700", hex: "#BE575C", depthLabel: "a dark muted rose shade" },
      { key: "800", label: "Rose 800", hex: "#98444A", depthLabel: "a very dark crimson-rose" },
      { key: "900", label: "Rose 900", hex: "#743139", depthLabel: "an extremely deep maroon-rose" }
    ],
    items: [
  ...
  },
  {
    ...
    shades: [
      ...
      { key: "deep", label: "DEEP", hex: "#166C82", depthLabel: "a deep dark teal base tone" }
    ],
    items: [
  ...
  },
  {
    ...
    shades: [
      ...
      { key: "base", label: "BASE", hex: "#DCB163", depthLabel: "the base grounded ochre tone" },
      { key: "deep", label: "DEEP", hex: "#8A5A00", depthLabel: "a deep warm earth shade" }
    ],
    items: [
